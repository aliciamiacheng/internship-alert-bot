...
|---|---|---|---:|---:|---|
| McKinsey | none | unconfigured | 0 | 0 | No approved listing source configured |
| BCG | none | unconfigured | 0 | 0 | No approved listing source configured |
| Bain | none | unconfigured | 0 | 0 | No approved listing source configured |
| Strategy& | none | unconfigured | 0 | 0 | No approved listing source configured |
| Oliver Wyman | none | unconfigured | 0 | 0 | No approved listing source configured |
| Kearney | none | unconfigured | 0 | 0 | No approved listing source configured |
| L.E.K. Consulting | none | unconfigured | 0 | 0 | No approved listing source configured |
| Roland Berger | none | unconfigured | 0 | 0 | No approved listing source configured |
| EY-Parthenon | none | unconfigured | 0 | 0 | No approved listing source configured |
| Deloitte | none | unconfigured | 0 | 0 | No approved listing source configured |
| Accenture | none | unconfigured | 0 | 0 | No approved listing source configured |
| PwC | none | unconfigured | 0 | 0 | No approved listing source configured |
| KPMG | none | unconfigured | 0 | 0 | No approved listing source configured |
| Alvarez & Marsal | none | unconfigured | 0 | 0 | No approved listing source configured |
| FTI Consulting | none | unconfigured | 0 | 0 | No approved listing source configured |
| West Monroe | none | unconfigured | 0 | 0 | No approved listing source configured |
...
| Arthur D. Little | none | unconfigured | 0 | 0 | No approved listing source configured |
| OC&C | none | unconfigured | 0 | 0 | No approved listing source configured |
| Booz Allen Hamilton | none | unconfigured | 0 | 0 | No approved listing source configured |
| Guidehouse | none | unconfigured | 0 | 0 | No approved listing source configured |
| Lumanity | none | unconfigured | 0 | 0 | No approved listing source configured |
| Goldman Sachs | none | unconfigured | 0 | 0 | No approved listing source configured |
| JPMorgan | none | unconfigured | 0 | 0 | No approved listing source configured |
| Morgan Stanley | none | unconfigured | 0 | 0 | No approved listing source configured |
| Bank of America | none | unconfigured | 0 | 0 | No approved listing source configured |
| Citi | none | unconfigured | 0 | 0 | No approved listing source configured |
| Barclays | none | unconfigured | 0 | 0 | No approved listing source configured |
| UBS | none | unconfigured | 0 | 0 | No approved listing source configured |
| Deutsche Bank | none | unconfigured | 0 | 0 | No approved listing source configured |
| HSBC | none | unconfigured | 0 | 0 | No approved listing source configured |
| BNP Paribas | none | unconfigured | 0 | 0 | No approved listing source configured |
| Societe Generale | none | unconfigured | 0 | 0 | No approved listing source configured |
| Nomura | none | unconfigured | 0 | 0 | No approved listing source configured |
| Jefferies | none | unconfigured | 0 | 0 | No approved listing source configured |
| Lazard | none | unconfigured | 0 | 0 | No approved listing source configured |
| Evercore | none | unconfigured | 0 | 0 | No approved listing source configured |
| Moelis | none | unconfigured | 0 | 0 | No approved listing source configured |
| PJT Partners | none | unconfigured | 0 | 0 | No approved listing source configured |
| Centerview Partners | none | unconfigured | 0 | 0 | No approved listing source configured |
| Rothschild & Co | none | unconfigured | 0 | 0 | No approved listing source configured |
| Qatalyst Partners | none | unconfigured | 0 | 0 | No approved listing source configured |
| Guggenheim Securities | none | unconfigured | 0 | 0 | No approved listing source configured |
| Macquarie | none | unconfigured | 0 | 0 | No approved listing source configured |
| SMBC | none | unconfigured | 0 | 0 | No approved listing source configured |
| MUFG | none | unconfigured | 0 | 0 | No approved listing source configured |
| Scotiabank | none | unconfigured | 0 | 0 | No approved listing source configured |
| Wells Fargo | none | unconfigured | 0 | 0 | No approved listing source configured |
| PIMCO | none | unconfigured | 0 | 0 | No approved listing source configured |
| BlackRock | none | unconfigured | 0 | 0 | No approved listing source configured |
| Fidelity | none | unconfigured | 0 | 0 | No approved listing source configured |
| Capital Group | none | unconfigured | 0 | 0 | No approved listing source configured |
| Wellington Management | none | unconfigured | 0 | 0 | No approved listing source configured |
...
| Jane Street | greenhouse | ok | 228 | 0 |  |
...
| Apollo | none | unconfigured | 0 | 0 | No approved listing source configured |
| Carlyle | none | unconfigured | 0 | 0 | No approved listing source configured |
| EQT | none | unconfigured | 0 | 0 | No approved listing source configured |
| Brookfield | none | unconfigured | 0 | 0 | No approved listing source configured |
...
| Thoma Bravo | none | unconfigured | 0 | 0 | No approved listing source configured |
| Bain Capital | none | unconfigured | 0 | 0 | No approved listing source configured |
| StepStone Group | none | unconfigured | 0 | 0 | No approved listing source configured |
...
| Founders Fund | none | unconfigured | 0 | 0 | No approved listing source configured |
| Index Ventures | none | unconfigured | 0 | 0 | No approved listing source configured |
| GV | none | unconfigured | 0 | 0 | No approved listing source configured |
| Google | none | unconfigured | 0 | 0 | No approved listing source configured |
| Microsoft | none | unconfigured | 0 | 0 | No approved listing source configured |
| Amazon | none | unconfigured | 0 | 0 | No approved listing source configured |
